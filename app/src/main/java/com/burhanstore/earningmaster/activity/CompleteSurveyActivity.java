...
public class CompleteSurveyActivity extends AppCompatActivity implements
    ...
    private TextView CompleteSurvey_count_textView, points_textView, points_text;
    boolean first_time = true, CompleteSurvey_first = true;
    private int CompleteSurvey_count = 1;
    ...
    private void initPollfish() {
        Params params = new Params.Builder("b64779be-6828-453e-a0a3-ffb5c9784688")
                .rewardMode(true)
                .offerwallMode(false)
                .build();
    ...
    public void onPollfishSurveyCompleted(@NotNull SurveyInfo surveyInfo) {
        ...
        User_Add_Coins(CompleteSurveyActivity.this, random_points, DAILY_TYPE);
    ...
    public void onBackPressed() {
        Intent i = new Intent(CompleteSurveyActivity.this, MainActivity.class);
        startActivity(i);
        finish();
    }
