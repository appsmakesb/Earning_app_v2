...
import static com.burhanstore.earningmaster.helper.Constatnt.FCM_ID;
...
import static com.burhanstore.earningmaster.helper.Constatnt.UPDATE_FCM;
...
import com.burhanstore.earningmaster.some.topsheet.Coins_Dialog;
        ...
        if (AppController.getInstance().readFCM() == true) {
            JsonRequest stringRequest = new JsonRequest(Request.Method.POST, Base_Url, null,
                ...
                protected Map<String, String> getParams() {
                    ...
                    params.put(FCM_ID, String.valueOf(FirebaseMessaging.getInstance().getToken()));
