...
public class Section2AdsActivity extends AppCompatActivity implements IUnityAdsListener, IUnityAdsInitializationListener, IUnityAdsShowListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_section2_ads);
        ...
        if (addOrNoAddValue == 1) {
            if (points.equals("0")) {
                ...
                try {
                    ...
                    //Back Home
                    Intent i = new Intent(Section2AdsActivity.this, MainActivity.class);
                    startActivity(i);
                    finish();
    ...
    public void onUnityAdsError(UnityAds.UnityAdsError unityAdsError, String placementId) {
        Toast.makeText(activity, "Reward Ads Not Ready Please Try Again", Toast.LENGTH_SHORT).show();
    }
